...
def scatter(model, model_name, data, new_point, features, color_scale, title):
    ...
    # untuk memprediksi cluster untuk setiap titik pada data menggunakan model
    ...
    else:  # pada agglomerative dan dbscan dilakukan dengan cara menghitung jarak titik terdekat
...
st.set_page_config(
    page_title="11978- Unsupervised Learning", 
    page_icon="",
    layout="wide",
